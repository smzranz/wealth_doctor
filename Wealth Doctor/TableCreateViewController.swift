...
class TableCreateViewController: UIViewController {
    ...
    func creatingChatTable(){
        ...
        result = DataBaseManager.shared.ExecuteQuery(query: "create table CHAT (\(slno) integer primary key autoincrement not null, type text not null, \(server_Chat) text not null, ans_id text not null ,url text not null, product_id text not null , disable integer not null,chat_id text not null,time text not null,color text not null)")
        if result == true {
